              ...
              <div className="flex flex-col items-center md:flex-row gap-x-8 h-full px-16 ">
                ...
                <div className="w-full max-w-[300px] flex flex-col xl:justify-center items-center relative mx-auto xl:mx-0 ">
                  <div className="flex flex-col justify-center items-center text-center ">
                    ...
                    {/* positon */}
                    <div className="text-[12px] uppercase font-extralight tracking-wider ">{person.position}</div>
                  </div>
                </div>
                {/* quote & message */}
                ...
                xl:before:bg-white/20 xl:before:absolute xl:before:left-0 xl:before:h-[200px] relative xl:pl-20 ">
                  ...
                  {/* message */}
                  <div className="xl:text-lg text-sm text-center md:text-left ">{person.message}</div>
                </div>
              </div>
            </SwiperSlide>
          );
